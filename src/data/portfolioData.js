...
export const EXPERIENCES = [
  {
    ...
    highlights: [
      ...
      "Built JavaScript & Google Apps Script automation that cut evaluation review handling time from 60+ to 35 minutes (41% efficiency improvement).",
      "Developed interactive Looker Studio dashboards to visualize real-time KPI data and agent performance for executive action plans."
    ]
  },
  {
    id: "intouch-sup",
    ...
    highlights: [
      ...
      "Reviewed and validated data generated through AI-assisted systems and human inputs, driving +10-20% CSAT and QA KPI boosts.",
      "Created standardized automated tools and procedures reducing repetitive data entry tasks and handling time by 20%."
    ]
  },
  {
    id: "intouch-lead",
  ...
  },
  {
    ...
    category: "recent",
    highlights: [
      "Designed custom scripts and automation tools that reduced repetitive tasks and handling time by 20%.",
      "Audited technical support interactions with extreme attention to edge cases and documentation accuracy."
    ]
  },
  {
    id: "westman-interpreter",
    period: "Jun 2017 – May 2018",
    role: "Community Interpreter",
    company: "Westman Immigrant Services",
    location: "Manitoba, Canada 🇨🇦",
    category: "canada",
    isCanada: true,
    highlights: [
      "Provided English-Spanish community interpretation for non-English speaking clients and newcomers in Manitoba, Canada.",
      "Facilitated cross-cultural communication, community outreach, and essential service navigation."
    ]
  },
  {
    id: "maple-leaf",
    period: "Dec 2012 – May 2018",
    role: "Production Worker & Emergency Response Team Member",
    company: "Maple Leaf Foods Inc",
    location: "Manitoba, Canada 🇨🇦",
    category: "canada",
    isCanada: true,
    highlights: [
      "Worked in Manitoba, Canada for over 5.5 years in industrial production and safety operations.",
      "Active member of the Emergency Response Team; certified in Scissor Lift operation, Fire Extinguisher safety, CPR, and First Aid."
    ]
  },
  {
    id: "dhl",
    ...
    role: "Aviation Agent",
    company: "DHL Honduras",
    location: "Tegucigalpa, Honduras",
    category: "older",
    highlights: [
      "Tracked customer cargo abroad, filled cargo Air Waybills, and calculated physical and volumetric freight weights."
    ]
  },
  {
    id: "bodeguita",
    ...
    company: "Bodeguita Lopez",
    location: "Tegucigalpa, Honduras",
    category: "older",
    highlights: [
      "Managed customer telephone orders and prepared products for delivery."
    ]
  },
  {
    id: "lds-zone",
    period: "Oct 2009 – Oct 2011",
    role: "Zone Leader & Volunteer Service Representative",
    company: "The Church of Jesus Christ of Latter-day Saints",
    location: "Honduras",
    category: "older",
    highlights: [
      "Led groups of 20 or more individuals to meet organization goals and community service initiatives.",
      "Taught Spanish language courses to native English speakers and conducted daily community outreach."
    ]
  },
  {
    id: "incogehsa",
    ...
    category: "older",
    highlights: [
      "Installation and maintenance of business LAN networks, computer hardware assembly, and technical customer support."
    ]
  }
];
